...
app.controller('circuitMetricsController', [ '$scope', '$stateParams', '$state', '$interval', 'circuitMetricsData', 'refreshPeriod',
	function($scope, $stateParams, $state, $interval, circuitMetricsData, refreshPeriod) {
		...
		$scope.infoMessage = "";
		$scope.iFrameURL = "/ibm/console/webtop/eventviewer/eventViewer.jsp?sql=%22TNSQM_ResourceName%20like%20%27" + circuitId + "%27%22&transientname=All&view name=All&viewtype=global&datasource=NCOMS";
